...
export default function Stats() {
  return (
    <section className="bg-[#111311] border-y border-white/10">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 grid grid-cols-2 md:grid-cols-4 divide-x divide-white/10">
        {stats.map((s) => (
          <div key={s.label} className="p-8 md:p-12 text-center md:text-left">
